...
public class Office extends Rooms {
    ...
    public static void safe(){
        ...
        System.out.println("You cannot open the safe. You need to enter the passcode to unlock the safe. You have three guesses to try and open it.\n");
        while (attempts < 3){
